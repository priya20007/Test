...
class doctor
{
	...
	public void deleteChartAt_doctor() {
...
class patient
{
    String pid, pname, disease, gender;
    int age;
    void new_patient()
    {
        Scanner input = new Scanner(System.in);
...
public class HospitalManagement {
	...
	private static final doctor DisplayMode = null;
...
Calendar calendar = Calendar.getInstance();
 int  i,count1 = 4, count2 = 4, count3 = 4, count4 = 4, count5 = 4, count6 = 4;
...
s[i] = new staff();
 ...
 int choice, j,id, c1,status = 1, s1 = 1, s2 = 1, s3 = 1, s4 = 1, s5 = 1, s6 = 1;
 ...
 while (status == 1)
 {
         ...
         case 2:
             {
                 ...
                 while (s2 == 1)
                 {
                     ...
                     switch (c1)
                     {
                         ...
                         case 2:
                             {
                                 System.out.println("id \t Name \t Disease \t Gender \t Age");
                                 for (j = 0; j < count2; j++) {
                                     p[j].patient_info();
                                 }
                                 break;
	...
	private static Object doctor_info() {
		// TODO Auto-generated method stub
		return null;
	}
	}  
